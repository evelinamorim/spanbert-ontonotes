...
def collate_fn(batch):
    ...
    is_training_tensor = torch.tensor(is_training)
    ...
    return (input_ids_padded, input_mask_padded, text_len_padded, speaker_ids_padded, genre_tensor, is_training_tensor, gold_starts_padded, gold_ends_padded, cluster_ids_padded, sentence_map_padded)
